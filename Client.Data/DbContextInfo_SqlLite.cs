...
{
    public class DbContextInfoSqlLite : DbContext
    {
        public DbContextInfoSqlLite(DbContextOptions<DbContextInfoSqlLite> options):base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var assList = ass.GetExportedTypes()
                ...
                && x.IsSubclassOf(typeof(SqlLiteModel))).ToList();
